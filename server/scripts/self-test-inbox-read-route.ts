/**
 * Self-test for POST /api/inbox/messages/:id/read: supports both read and unread (isRead true/false),
 * scopes by customerId via senderIdentity, returns { success, id, isRead }.
 */
