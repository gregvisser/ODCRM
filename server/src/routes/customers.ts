...
router.post('/:id/enrich-about', async (req, res) => {
  return res.status(410).json({
    error: 'gone',
    message: 'Company enrichment has been removed from ODCRM.',
  })
})
...
router.post('/:id/agreement', async (req, res) => {
  try {
    ...
    // Keep agreement upload as a plain blob-backed storage path only.
...
// ============================================================================
// Company enrichment has been removed from ODCRM
// ============================================================================
