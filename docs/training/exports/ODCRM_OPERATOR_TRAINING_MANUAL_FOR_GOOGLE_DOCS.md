...
Share-ready Google Docs version.
...
## Start Here
This version is formatted for easy copy and paste into Google Docs while keeping the same operator guidance as the main ODCRM training manual.
