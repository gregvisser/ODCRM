...
### Intended audience
- ODCRM operators managing client outreach
- account managers and onboarding staff
- team leads and trainers supporting new users

### How to use this guide
1. Start with the quickstart sections.
2. Follow the core workflow in order.
3. Use the playbooks while doing the task in ODCRM.
4. Use the module guide and gotchas sections when you need detail or recovery guidance.
